...
const Page = () => {
  ...
  const { title, synopsis, date } = i18n.heweliusz;
  ...
  return (
    <div className="page-container">
      <VimeoPlayer
        src={'https://player.vimeo.com/video/1109052512'}
      />
      ...
      <div className="info-container">
        ...
        <div className="credits">
          ...
          <div className="production-credits">
            <p className="text">
              <span>{productionCompany}:</span> Telemark & Beside Productions
            </p>
            <p className="text">
              <span>Showrunner:</span> Jan Holoubek{' '}
            </p>
          </div>
        </div>
        <div className="credits">
